...
__plugin__ = "Malaysia Free To Air"
__author__ = 'Suaji <suaji86@gmail.com>'
__url__ = 'http://https://github.com/suaji/plugin.video.malaysia.live/'
__date__ = '28-11-2014'
__version__ = '1.0.0'
__settings__ = xbmcaddon.Addon(id='plugin.video.malaysia.live')
