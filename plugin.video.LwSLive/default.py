...
if action == None:
    from resources.lib.indexers import LwSLive
    LwSLive.getCategory()

elif action == 'dmode' or action == 'ndmode':
    from resources.lib.indexers import LwSLive
    LwSLive.getDirectory(name, url, audio, image, fanart, content)

elif action == 'subDirectory':
    from resources.lib.indexers import LwSLive
    LwSLive.subDirectory(name, url, audio, image, fanart, tvshow, content)

elif action == 'localDirectory':
    from resources.lib.indexers import LwSLive
    LwSLive.localDirectory()
    ...
    from resources.lib.indexers import LwSLive
    LwSLive.searchDirectory()

elif action == 'searchDirectory2':
    from resources.lib.indexers import LwSLive
    LwSLive.searchDirectory(url)
